...
func (obj *Chessboard) CreateWindow() {
	...
	obj.w, obj.h = 1280, 720                                         //窗口的宽度和高度
	obj.window.SetSizeRequest(1280, 720)                             //设置窗口的宽高
	...
	//image相关
	obj.imageLOGO = gtk.ImageFromObject(builder.GetObject("imageLOGO"))
	obj.imageWhite = gtk.ImageFromObject(builder.GetObject("imageWhite"))

	//设置图片
	ImageSetPicFromFile(obj.imageLOGO, "../image/LOGO.png")
